                    ...
                    @foreach($contacts as $index=>$val)
                        <tr>
                            ...
                            <td>@if($val->status == 0)
                                ...
                                @endif</td>
                            <td><a class="btn btn-info" href="{{route('category.edit',$val->id)}}"><i class="fa fa-eye"></i></a> &nbsp; <a href="#" class="btn btn-danger"><i class="fa fa-times" data-toggle="modal" data-target="#exampleModal-{{$index}}"></i></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                    <tfoot>
