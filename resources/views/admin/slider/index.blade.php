    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Manage Slider &nbsp; &nbsp; <a href="{{route('slider.create')}}"><button class="btn btn-success"><i class="fa fa-pen"></i> Add Slider</button></a></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($sliders as $index=>$val)
                        <tr>
                            ...
                            <td><a class="btn btn-info" href="{{route('slider.edit',$val->id)}}"><i class="fa fa-edit"></i></a> &nbsp; <a href="#" class="btn btn-danger"><i class="fa fa-times" data-toggle="modal" data-target="#exampleModal-{{$index}}"></i></a></td>
                        </tr>
                    @endforeach
